...
LD mismatch diagnosis (using SuSiE RSS) 
with precomputed LD matrices from UK Biobank reference.
...
We choose one example locus, load UKBB reference LD matrix, and
...
We run finemapping with precomputed UKBB LD matrices (we use uniform prior in this tutorial)
```{r}
