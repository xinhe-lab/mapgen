...
annotations_dir <- system.file("extdata", "test_bed_dir/", package="mapgen")
annotation_bed_files <- list.files(path = annotations_dir, pattern = "*.bed", full.names = TRUE)
...
You can set `option = "fdr"` to get the probability of each locus 
containing a causal signal. 
```{r run-torus-fdr}
