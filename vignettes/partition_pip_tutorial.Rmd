...
categories <- c("Cardiomyocyte", "Endothelial", "Fibroblast", "Lymphoid", "Myeloid", "Pericyte", "Shared 2-3", "Shared 4+")
colors <- c("Cardiomyocyte" = "#b22222", "Endothelial" = "#8DD3C7", "Fibroblast" = "#BEBADA", "Lymphoid" = "#FB8072", "Myeloid" = "#80B1D3",
            "Pericyte" = "#B3DE69", "Shared 2-3" = "royalblue", "Shared 4+" = "#003C86")
