...
They can be downloaded [here][UKBB_LD]. See the 
[Fine-mapping and LD diagnosis tutorial][finemapping-ukbb-ld-diagnosis-tutorial] 
for details.
...
the [diagnostic][diagnostic-susie-rss] from `susie_rss`. See the 
[Fine-mapping and LD diagnosis tutorial][finemapping-ukbb-ld-diagnosis-tutorial] 
for details.
