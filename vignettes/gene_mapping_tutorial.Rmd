...
```{r load-pcHiC}
genomic.annots$pcHiC <- readRDS('../inst/extdata/pcHiC.CM.gr.rds')
```
...
```{r active.promoters}
genomic.annots$OCRs_hg19 <- readRDS('../inst/extdata/OCRs.hg19.gr.rds')
...
genomic.annots$enhancer_nearby_promoter_20kb <- readRDS('../inst/extdata/enhancer.nearby.promoter.20kb.gr.rds')
```
