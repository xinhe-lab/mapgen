...
then make gene annotations using the `make_genomic_annots()` function with GTF file. 
```{r, eval=TRUE, include=FALSE}
gtf_file <- '../../mapgen_tutorial_data/trackplot/gencode.v19.annotation.gtf.gz'
```
