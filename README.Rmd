...
`tidyverse`, `data.table`, `ggplot2`, `R.utils`from CRAN,
...
and `processx` R package, if you want to run 
enrichment analysis using TORUS. 
* Please install R packages: `Gviz`, `GenomicInteractions` from Bioconductor
if you want to make genomic track plots (gene locus plots) of 
functional fine-mapping result.
