...
* Please install [susieR](https://github.com/stephenslab/susieR) package, if you want to 
...
```{r workflow.overview, echo=FALSE, fig.cap="", out.width = '75%'}
knitr::include_graphics("man/figures/workflow.overview.png")
```

Please follow the [tutorials](https://xinhe-lab.github.io/mapgen/articles/index.html) to use the package.
